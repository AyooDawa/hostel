...
$rc=$stmt->bind_param('iiisisissssisississs',$roomno,$seater,$feesps,$stayfrom,$duration,$course,$regno,$fname,$mname,$lname,$gender,$contactno,$emailid,$emcntno,$gurname,$gurrelation,$gurcntno,$paddress,$pcity,$pcounty);
$stmt->execute();
$stmt->close();
...
<body>
	...
	<div class="ts-main-content bk-success">
...
<div class="col-sm-8">
<select name="pcounty" id="pcounty"class="form-control" required> 
