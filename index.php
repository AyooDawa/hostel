...
<head>
	...
	<title>Student HosteL Booking System</title>
...
<body>
	...
	<div class="ts-main-content bg-secondary">
				...
				<div class="row">
					...
					<div class="col-md-6 col-md-offset-3">
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
								...
								<form action="" class="mt" method="post">
									<label for="" class="text-uppercase text-sm" style="color:green;">Email / Registration Number</label>
						...
						<div class="text-center text-light" style="color:black;">
							<a href="forgot-password.php" style="color:green;">Forgot password?</a>
						</div>
					</div>
				</div>
						</div>
